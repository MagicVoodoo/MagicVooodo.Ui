...
using GTKControl = Xamarin.Forms.Platform.GTK.Controls;

[assembly: ExportRenderer(typeof(HybridWebView), typeof(MagicVoodoo.Xamarin.GTK.HybridWebViewRenderer))]
namespace MagicVoodoo.Xamarin.GTK
{
    public class HybridWebViewRenderer : ViewRenderer<WebView, GTKControl.WebView>, IWebViewDelegate, IEffectControlProvider
    {
            ...
            if (e.NewElement != null)
            {
                if (Control == null)
                {
                    try
                    {
                        ...
                        Control = new GTKControl.WebView();
                    }
                    catch (Exception ex)
                    {
                    ...
                    WebViewController. += OnReloadRequested;
                }
            }
